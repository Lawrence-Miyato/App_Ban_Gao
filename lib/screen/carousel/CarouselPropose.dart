...
class Carouselpropose extends StatefulWidget {
  const Carouselpropose({super.key});

  @override
  State<Carouselpropose> createState() => _CarouselproposeState();
}

class _CarouselproposeState extends State<Carouselpropose> {
  @override
